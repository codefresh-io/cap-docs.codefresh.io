...
| Plugin mechanism   | Java/Groovy using Jenkins API | [Docker image](https://github.com/codefresh-io/2.0-marketplace) (any programming language)|
...
shared library. Codefresh also has a [free marketplace](https://github.com/codefresh-io/2.0-marketplace) for pipeline steps (which are Docker images essentially).
