...
Codefresh has native support for interacting with the GitHub Container registry.  
...
* Make sure you have a personal access token with the correct scopes or create one.  
  For detailed information, see [Authenticating to the Container registry](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry#authenticating-to-the-container-registry){:target="\_blank"}.
...
| **GitHub Token**   | The GitHub PAT (personal access token).|
