...
Codefresh also offers a [plugin marketplace](https://github.com/codefresh-io/2.0-marketplace) with several existing plugins.
...
CollectAllMyDeps:
  ...
  commands:
    - pip install .
```
For the plugins in the [Step Marketplace](https://github.com/codefresh-io/2.0-marketplace) we already give an example of the YAML part that must be included in your pipeline:
