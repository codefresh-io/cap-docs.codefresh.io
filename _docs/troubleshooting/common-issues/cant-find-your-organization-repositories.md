...
I want to add a [git trigger]({{site.baseurl}}/docs/pipelines/triggers/git-triggers/) for a repository that belongs to one of my GitHub organizations, but can't find the organization with the repository in the list.
