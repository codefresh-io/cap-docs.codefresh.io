...
1. Deploys the Helm chart to a cluster named `my-demo-k8s-cluster` using the Helm step [from the Step Marketplace](https://github.com/codefresh-io/2.0-marketplacestep/helm).
