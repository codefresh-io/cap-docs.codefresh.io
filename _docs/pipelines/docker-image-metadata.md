...
{% include image.html lightbox="true" file="/images/pipeline/docker-image/example2.png" url="/images/pipeline/docker-image/example2.png" alt="Screen Shot 2017-10-08 at 8.28.35 AM.png" max-width="40%" %}
