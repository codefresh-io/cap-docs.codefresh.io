...
| ------------------------| ---------------- |
|**Runtime**             |  indicates ![](/images/icons/codefresh-runtime.png?display=inline-block) the cluster on which the runtime is provisioned. The cluster name is identical to that of the in-cluster. |
